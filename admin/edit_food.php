...
if (isset($_POST['save_changes'])) {
    ...
    if (array_filter($error)) {
        ...
        if ($size != 0) {
            ...
            print_r($check);
            if (in_array($img_ex_lc, $allowed_exs) && $check) {
            ...
            $sql = "UPDATE food SET food_name='$food_name',food_desc='$food_desc',food_price='$food_price' WHERE food_id='$_SESSION[food_id]'";
        }
                ...
                <form action="edit_food.php" class="container section" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="center">
                        <div class="input-field">
                            <input type="submit" class="btn orange" name="save_changes" value="Save changes">
                        </div>
                    </div>
